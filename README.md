...
`./word-maker`. This directory also contains a _README.md_ with details about its usage and API. The module
is already _required_ for you in `src/index.js`
...
3. Create a version of steps _1_ and _2_ using the **asynchronous** function, `getRandomWord`. This function
